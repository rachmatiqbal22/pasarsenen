          ...
          <ul class="thumbnails">
            <div class="btn-icon-pg">
              <ul>
                <!--Looping-->
                <?php
                  $query_data_makanan = "select * from tb_sayur order by id_sayur desc";
                ...
                ?>
                    <li class="span2"> 
                      ...
                      <form action="" method="post">
                        <button type="submit" value="<?php echo $r_dt_sayur['id_sayur'];?>" name="edit_menu" class="btn btn-success btn-mini"><i class='icon-pencil'></i>&nbsp;&nbsp;Edit &nbsp;&nbsp;</button>
                        <button type="submit" value="<?php echo $r_dt_sayur['id_sayur'];?>" name="hapus_menu" class="btn btn-mini btn-danger"><i class='icon icon-trash'></i>&nbsp; Hapus</button>
                      </form>
                    </li>
                  <?php
                    }
                    if(isset($_REQUEST['hapus_menu'])){
                      ...
                      $id_sayur = $_REQUEST['hapus_menu'];

                      $query_lihat = "select * from tb_sayur where id_sayur = $id_sayur";
                      $sql_lihat = mysqli_query($conn, $query_lihat);
                      $result_lihat = mysqli_fetch_array($sql_lihat);
                      if(file_exists('gambar/'.$result_lihat['gambar_sayur'])){
                        //echo $result_lihat['gambar_sayur'];
                        unlink('gambar/'.$result_lihat['gambar_sayur']);
                      }
                      $query_hapus_masakan = "delete from tb_sayur where id_sayur = $id_sayur";
                    ...
                    if(isset($_REQUEST['edit_menu'])){
                      //echo $_REQUEST['hapus_menu'];
                      $id_sayur = $_REQUEST['edit_menu'];
                      $_SESSION['edit_menu'] = $id_sayur;
