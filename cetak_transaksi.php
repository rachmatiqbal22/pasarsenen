  ...
  <page size="dipakai" layout="landscape">
    ...
    ?>
      <center>
        ...
        <p>
        Kritik dan Keluhan, Hubungi : 08978336363
        </p>
      </center>
            <hr>
              ...
              <table class="table table-bordered">
                <thead>
                  <tr>
                    ...
                    <th class="head1">Daftar Sayur</th>
                ...
                <tbody>
                  <?php
                    $no_order_fiks = 1;
                    $query_order_fiks = "select * from tb_pesan natural join tb_sayur where id_order = $id_order";
