...
<!--Header-part-->
<div id="header">
  <h1><a href="daftar.php">Pasar Senen</a></h1>
</div>
<!--close-Header-part--> 
  ...
  <ul class="nav">
    <li  class="dropdown" id="profile-messages" ><a title="" href="#" data-toggle="dropdown" data-target="#profile-messages" class="dropdown-toggle"><i class="icon icon-user"></i>  <span class="text">&nbsp;Selamat Datang Pendaftar</span><b class="caret"></b></a>
      <ul class="dropdown-menu">
        <li><a href="index.php"><i class="icon-key"></i> Masuk</a></li>
      </ul>
    </li>
  </ul>
</div>
        ...
        <div class="widget-content nopadding">
          <form action="" method="post" class="form-horizontal">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input name="username" type="text" class="span11" placeholder="Nama Pengguna" />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">Kata Sandi</label>
              <div class="controls">
                <input name="password" type="password"  class="span11" placeholder="Kata Sandi"  />
              </div>
            </div>
            <div class="control-group">
              ...
              <div class="controls">
                <select class="span11" name="id_level">
                  ...
                  <option value="2">Pengirim</option>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input name="no_hp" type="text" class="span11" placeholder="No. Handphone" />
              </div>
            </div>
          ...
          <?php
            if(isset($_POST['kirim_daftar'])){
              ...
              $no_hp = $_POST['no_hp'];
              //echo "<br>";
              //echo $nama_user . " || " . $username . " || " . $password . " || " . $id_level . " || " . $status || " . $no_hp;
              //echo "<br></br>";
              $query_daftar = "insert into tb_user values ('','$username','$password','$nama_user','$id_level','$status','$no_hp')";
