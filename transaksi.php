            ...
            <table class="table table-bordered table-invoice-full">
              <thead>
                <tr>
                  ...
                  <th class="head1">Sayur</th>
                  <th class="head1">Nama Pedagang</th>
              ...
              <tbody>
                <?php
                  $no_order_fiks = 1;
                  $query_order_fiks = "select * from tb_pesan left join tb_sayur on tb_pesan.id_sayur = tb_sayur.id_sayur where id_user = $id_pemesan and status_pesan != 'sudah'";
                ...
                <tr>
                  ...
                  <td><?php echo $r_order_fiks['nama_pedagang'];?></td>
                ...
                <tr>
                  <td></td>
                  <td><strong><center>Alamat</center></strong></td>
                  <td class="right"></td>
                  <td class="right"></td>
                  <td class="right"></td>
