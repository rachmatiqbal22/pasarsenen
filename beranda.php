...
if (isset($_POST['submit'])) {
  ...
  $query_insert = "INSERT INTO tb_user (nama_user, username, status, no_hp) VALUES ('$nama', '$username', '$status', '$no_hp')";
...
<div id="sidebar"><a href="beranda.php" class="visible-phone"><i class="icon icon-home"></i> Beranda</a>
  ...
  <?php
    if($r['id_level'] == 1){
  ?>
    <li class="active"><a href="beranda.php"><i class="icon icon-home"></i> <span>Data Pengguna</span></a> </li>
    ...
    ?>
        ...
        <div class="widget-content" >
          <div class="row-fluid">
              ...
              <div class="widget-box">
                <div class="widget-content nopadding">
                  <ul class="site-stats quick-actions">
                    ...
                    <li class="bg_ly"><i class="icon-user"></i> <strong><?php echo $result_wtr['jumlah_wtr']; ?></strong> <small>Total Pengirim</small></li>
                    <li class="bg_ls"><i class="icon-user"></i> <strong><?php echo $result_own['jumlah_own']; ?></strong> <small>Total Penjual</small></li>
            ...
            <div class="span9">
              ...
              <div class="widget-box">
                <?php
                  $query_data_own = "select * from tb_user where id_level = 3";
              ...
              <div class="widget-box">
                <?php
                  $query_data_plg = "select * from tb_user where id_level = 4";
      ...
      <div class="alert alert-orange alert-block">
        <center>
          ...
          Di Sistem Penjualan Sayur di Pasar Senen.
