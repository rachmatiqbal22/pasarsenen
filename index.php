		...
		<div class="container-login100" style="background-image: url('template/masuk/images/img-01.jpg');">
			<div class="wrap-login100 p-t-120 p-b-30">
				<form action="" method="post" class="login100-form validate-form">
					...
					?>
						<div class='container'>	
							<div class = 'alert alert-danger'>
								<span>
									<center>Akun Tidak Di Temukan Atau Belum Divalidasi Oleh Admin</center>
								</span>
							</div> 
						</div>
					<?php 
					...
					<div class="wrap-input100 validate-input m-b-10" data-validate = "Nama Pengguna Tidak Boleh Kosong">
