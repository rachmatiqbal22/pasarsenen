...
<!--close-top-serch-->
<!--sidebar-menu-->
<div id="sidebar"><a href="generate_laporan.php" class="visible-phone"><i class="icon icon-print"></i> <span>Laporan</span></a>
  <ul>
    <?php
    if($r['id_level'] == 1){
  ?>
...
<!--breadcrumbs-->
  <div id="content-header">
    <div id="breadcrumb"> <a href="generate_laporan.php" title="Go to here" class="tip-bottom"><i class="icon icon-print"></i> Laporan</a></div>
  </div>
<!--End-breadcrumbs-->
          ...
          <div class="widget-content nopadding" >
            <table class="table table-bordered table-invoice-full">
              ...
              <?php
                ...
                $query_lihat_menu = "select * from tb_sayur";
              ...
              ?>
                <tr>
                  ...
                  <td><?php echo $r_lihat_menu['nama_sayur'];?></td>
                  <td><center><?php echo $r_lihat_menu['stok'];?></center></td>
                  <td>
                    <center>
                      <?php
                        $id_sayur = $r_lihat_menu['id_sayur'];
                        $query_lihat_stok = "select * from tb_stok left join tb_pesan on tb_stok.id_pesan = tb_pesan.id_pesan left join tb_sayur on tb_pesan.id_sayur = tb_sayur.id_sayur where status_cetak = 'belum cetak'";
                        $query_jumlah = "select sum(jumlah_terjual) as jumlah_terjual from tb_stok left join tb_pesan on tb_stok.id_pesan = tb_pesan.id_pesan where id_sayur = $id_sayur and status_cetak = 'belum cetak'";
